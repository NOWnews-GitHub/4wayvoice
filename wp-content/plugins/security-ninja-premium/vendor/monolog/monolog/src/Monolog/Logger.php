...
namespace WPSecurityNinja\Plugin\Monolog;

use WPSecurityNinja\Plugin\Monolog\Handler\HandlerInterface;
use WPSecurityNinja\Plugin\Monolog\Handler\StreamHandler;
use WPSecurityNinja\Plugin\Psr\Log\LoggerInterface;
use WPSecurityNinja\Plugin\Psr\Log\InvalidArgumentException;
use Exception;
